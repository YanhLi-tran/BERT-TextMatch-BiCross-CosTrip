...
|:----|:-------------------:|:---------------------:|:-----------------------------:|:------------------------:|:------------------------:|:-------------------------:|
| 训练 Epoch | 49 | 60 | 46 | 66 | 57 | — |
| Test Acc | 87.83% | 89.20% | **93.48%** | 92.52% | **94.22%** | ⏳ |
| Precision | — | — | **94.75%** | — | **94.87%** | ⏳ |
| Recall | — | — | **92.29%** | — | — | — |
| F1 | 88.45% | 89.62% | **93.50%** | 92.62% | **94.30%** | ⏳ |
| AUC-ROC | 0.9131 | 0.9188 | **0.9793** | 0.9627 | **0.9819** | ⏳ |
| MCC | — | — | — | — | — | — |
| 最优阈值 | 0.35 | — | — | — | — | — |
...
| 场景 | 推荐方案 | 理由 |
|------|---------|------|
| 追求最高精度 | **BiEncoder + Mean + Triplet(Online)** | Test Acc 93.48%，F1 93.50%，AUC 0.9793 |
| BiEncoder 最佳 | **BiEncoder + Mean + Cosine** | Test Acc 89.20%，F1 89.62% |
| 追求精准、少误报 | **BiEncoder + Mean + Triplet(Online)** | Precision 94.75%，FP 仅 224 |
| 中小规模检索 | **BiEncoder + FAISS** | 0.49s 检索 8620 条候选，Recall@50=43% |
| RAG 级联方案 | **BiEncoder 粗筛 → CrossEncoder 精排** | 兼顾速度与精度 |

BiEncoder + Mean + Triplet (Online) 以 **93.48%** 测试准确率成为当前最佳方案。扩大 batch 规模（32→64）后所有实验均有显著提升：CLS+Cosine 从 86.47% 提升至 87.83%，Mean+Cosine 从 86.91% 提升至 89.20%。
...
- [x] Exp-3: BiEncoder + Mean + Triplet (Online, b=64) — **93.48%**
