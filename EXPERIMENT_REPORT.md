...
| 指标 | Exp-1 (Bi+CLS+Cosine) | Exp-2 (Bi+Mean+Cosine) | Exp-3 (Cross+Mean+Cosine) | **Exp-4 (Cross+CLS+Classify)** |
|------|:--------------------:|:----------------------:|:------------------------:|:----------------------------:|
| **Test Accuracy** | 86.47% | 86.91% | 87.35% | **92.34%** |
| **Precision** | 83.46% | 84.51% | 87.96% | **92.78%** |
| **Recall** | **91.13%** | 90.92% | 87.04% | 92.10% |
| **F1 Score** | 87.12% | 87.60% | 87.50% | **92.44%** |
| **AUC-ROC** | 0.9122 | 0.9036 | 0.9313 | **0.9736** |
| **MCC** | 0.7325 | — | 0.7471 | **0.8469** |
| **最优阈值** | 0.35 | 0.60 | 0.60 | 不适用（argmax）|

> CrossEncoder + CLS + 分类头（CrossEntropyLoss）以 **92.34%** 测试准确率全面领先其他方案，F1 达 **92.44%**，AUC **0.9736**，是当前全部实验中的最佳结果。
