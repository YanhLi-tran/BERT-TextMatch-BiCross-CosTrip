...
|:----|:------------:|:--------------:|:-------------------------:|:----------------:|:-----------------:|:------------------:|
| 训练 Epoch | 18 | 21 | 86 | 18 | 30 | 29 |
| Test Acc | 86.47% | 86.91% | **94.23%** | 87.35% | 92.34% | 91.29% |
| Precision | 83.46% | 84.51% | **95.29%** | 87.96% | 92.78% | 91.01% |
| Recall | 91.13% | 90.92% | **93.27%** | 87.04% | 92.10% | 91.94% |
| F1 | 87.12% | 87.60% | **94.27%** | 87.50% | 92.44% | 91.47% |
| AUC-ROC | 0.9122 | 0.9036 | **0.9805** | 0.9313 | 0.9736 | 0.9686 |
| MCC | 0.7325 | - | - | 0.7471 | 0.8469 | 0.8257 |
| 最优阈值 | 0.35 | 0.60 | 0.70 | 0.60 | argmax | argmax |
...
| 实验 | TP | FP | FN | TN |
|------|:--:|:--:|:--:|:--:|
| Exp-3 (Bi+Mean+Triplet) | **4,078** | **200** | **294** | **4,048** |
...
| 追求精准、少误报 | **BiEncoder + Mean + Triplet(Online)** | Precision 95.29%，FP 仅 200 |
| 衡量排序质量 | **BiEncoder + Mean + Triplet(Online)** | AUC 0.9805 |
