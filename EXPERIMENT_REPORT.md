...
| 指标 | Exp-1 (Bi+CLS+Cosine) | Exp-2 (Bi+Mean+Cosine) | Exp-3 (Cross+Mean+Cosine) | **Exp-4 (Cross+CLS+Classify)** | **Exp-5 (Cross+Mean+Classify)** |
|------|:--------------------:|:----------------------:|:------------------------:|:----------------------------:|:-----------------------------:|
| **Test Accuracy** | 86.47% | 86.91% | 87.35% | **92.34%** | 91.29% |
| **Precision** | 83.46% | 84.51% | 87.96% | **92.78%** | 91.01% |
| **Recall** | **91.13%** | 90.92% | 87.04% | 92.10% | **91.94%** |
| **F1 Score** | 87.12% | 87.60% | 87.50% | **92.44%** | 91.47% |
| **AUC-ROC** | 0.9122 | 0.9036 | 0.9313 | **0.9736** | 0.9686 |
| **MCC** | 0.7325 | — | 0.7471 | **0.8469** | 0.8257 |
| **最优阈值** | 0.35 | 0.60 | 0.60 | 不适用（argmax）| 不适用（argmax）|
...
- [x] Exp-3: CrossEncoder + Mean + Cosine
- [x] Exp-4: CrossEncoder + CLS + 分类头
- [x] Exp-5: Hard Negative Mining（已完成数据构建）
- [x] Exp-6: CrossEncoder + Mean + Cosine 评估
- [ ] Exp-7: 两阶段训练（Cosine → Triplet + Hard Negative，margin=0.5, lr=5e-6）
- [ ] Exp-8: CrossEncoder + CLS + 分类头测试集评估
- [ ] Exp-9: 输出最终实验数据到 GitHub
